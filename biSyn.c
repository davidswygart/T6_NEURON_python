...
#define nrn_init _nrn_init__biSyn
#define _nrn_initial _nrn_initial__biSyn
#define nrn_cur _nrn_cur__biSyn
#define _nrn_current _nrn_current__biSyn
#define nrn_jacob _nrn_jacob__biSyn
#define nrn_state _nrn_state__biSyn
...
#define isT isT_biSyn
 extern double isT( _threadargsprotocomma_ double );
...
#if NMODL_TEXT
static const char* nmodl_filename = "biSyn.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
