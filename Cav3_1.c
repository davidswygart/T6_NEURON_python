...
#define rates rates__Cav3_1 
#define states states__Cav3_1 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "gCav3_1bar_Cav3_1", "S/cm2",
 "ica_Cav3_1", "mA/cm2",
 "gCav3_1_Cav3_1", "S/cm2",
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 Cav3_1 C:/Users/david/Documents/Code/Github/T6_NEURON_python/Cav3_1.mod\n");
...
static int  rates ( _threadargsproto_ ) {
    mInf = 1.0 / ( 1.0 + exp ( ( v - ( - 42.921064 ) ) / - 5.163208 ) ) ;
   if ( v < - 10.0 ) {
...
#if NMODL_TEXT
static const char* nmodl_filename = "Cav3_1.mod";
static const char* nmodl_file_text = 
