...
class model():  
    def __init__(self):
        ...
        self.ribRec = f.recordRibbons(h, "InputData/RibbonLocations.txt")                #A list of voltage recording vectors at each ribbon
        ...
        if self.settings.DoVClamp:
            ...
            f.runSim(h, self.settings, self.inhSyns, self.segRec, self.ribRec)
